...
public class ReservationForm extends JFrame {
    ...
    public ReservationForm(ArrayList<Customer> customers, String currentUser) {
        ...
        formPanel.add(new JLabel("Lapangan:"));
        ...
        // Tabel reservasi
        tableModel = new DefaultTableModel(new String[]{"ID Reservasi", "ID Customer", "Nama", "Tanggal", "Jam", "Lapangan", "Jumlah Orang", "Last Action By:"}, 0);
    ...
    private void saveReservation() {
        ...
        if (table.isEmpty()) {
            JOptionPane.showMessageDialog(this, "Lapangan harus diisi.");
            return;
        }
